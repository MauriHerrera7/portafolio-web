      ...
      <main className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 md:mb-16">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-retro font-bold bg-gradient-to-r from-cyan-400 via-blue-500 to-cyan-300 bg-clip-text text-transparent mb-4 md:mb-6">
              Trabajemos Juntos
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="order-2 lg:order-1">
              <h2 className="text-2xl md:text-3xl font-retro font-semibold text-blue-600 dark:text-cyan-400 mb-6 md:mb-8 text-center lg:text-left">
                Información de Contacto
              </h2>
              
              <div className="space-y-4 md:space-y-6 mb-8">
                <div className="contact-card group bg-gray-50 dark:bg-gray-800/50 border-2 border-gray-300 dark:border-gray-600 rounded-lg p-4 md:p-6 hover:border-cyan-400 dark:hover:border-cyan-300 hover:shadow-lg hover:shadow-cyan-400/30 dark:hover:shadow-cyan-300/30 transition-all duration-300 hover:shadow-blue-500/20">
                  <div className="flex items-center">
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className="text-base md:text-lg font-retro font-medium bg-gradient-to-r from-cyan-600 to-blue-700 bg-clip-text text-transparent dark:from-cyan-300 dark:to-blue-300">
                        Email
                      </h3>
                      <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 font-code truncate">
                        mauricio@ejemplo.com
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="contact-card group bg-gray-50 dark:bg-gray-800/50 border-2 border-gray-300 dark:border-gray-600 rounded-lg p-4 md:p-6 hover:border-cyan-400 dark:hover:border-cyan-300 hover:shadow-lg hover:shadow-cyan-400/30 dark:hover:shadow-cyan-300/30 transition-all duration-300 hover:shadow-blue-500/20">
                  <div className="flex items-center">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 font-code">
                        +52 123 456 7890
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex justify-center lg:justify-start gap-4">
                <a href="#" className="p-3 bg-gray-100 dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:border-blue-400 dark:hover:border-cyan-400 hover:shadow-lg transition-all duration-300 group">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div>
                      <input
                        ...
                        required
                        className="neon-input w-full px-3 md:px-4 py-2.5 md:py-3 bg-white dark:bg-gray-900/50 border-2 border-gray-300 dark:border-cyan-400/30 focus:border-blue-500 dark:focus:border-cyan-400 text-gray-900 dark:text-white font-code text-sm md:text-base rounded-lg focus:outline-none transition-all duration-300"
                      />
                    </div>
                    <div>
                      <input
                  ...
                  <div>
                    <textarea
                      ...
                      required
                      className="neon-input w-full px-3 md:px-4 py-2.5 md:py-3 bg-white dark:bg-gray-900/50 border-2 border-gray-300 dark:border-cyan-400/30 focus:border-blue-500 dark:focus:border-cyan-400 text-gray-900 dark:text-white font-code text-sm md:text-base rounded-lg focus:outline-none transition-all duration-300 resize-none"
                    ></textarea>
                  </div>
