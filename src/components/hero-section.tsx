      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center justify-center min-h-screen py-20 lg:py-0">
        ...
        <div className="w-full lg:max-w-2xl text-center lg:text-left mb-12 lg:mb-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8 justify-center lg:justify-start">
            <a 
              href="/CV.pdf" 
              download="CV_Mauricio_Herrera.pdf"
              className="bg-gradient-to-r from-cyan-600 to-blue-600 dark:from-cyan-500 dark:to-blue-500 px-6 sm:px-8 py-3 rounded-lg font-semibold hover:shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 text-sm sm:text-base text-white text-center"
            >
              Descargar CV
            </a>
          ...
          <div className="flex gap-4 sm:gap-6 justify-center lg:justify-start">
            ...
            <a href="mailto:mauriherrera457@gmail.com" className="text-gray-500 dark:text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">
              <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 12.713l-11.985-9.713h23.97l-11.985 9.713zm0 2.574l-12-9.725v15.438h24v-15.438l-12 9.725z"/>
              </svg>
            </a>
            <a href="https://wa.me/542615552184?text=Hola%2C%20me%20gustar%C3%ADa%20obtener%20m%C3%A1s%20informaci%C3%B3n." target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">
              <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
